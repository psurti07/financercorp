...
(2, '2026-03-11 10:10:09', 'Admin', NULL, '9983933307', 'info@financercorp.com', '$2y$12$ae7HMdoOu6ZigC8qVfZ6qumvdACgxKUixxZVs5O2mtspDf/7elgc6', '7130', NULL, 0, 1, 0),
(3, '2026-03-30 16:52:55', 'Self Apply Staff', NULL, '9983933307', 'staff@financercorp.com', '$2y$12$kJerJ5pyEJKy4ujqaFWze.LGJw9U956aHGun826WSf56GolvGCj1e', '3721', NULL, 5, 1, 0),
(4, '2026-03-30 16:54:17', 'Loan Agent Staff', NULL, '9983933307', 'support@financercorp.com', '$2y$12$vahFz2qTqgrGozEmpSktt.6NZwkICwh5Ou7E7BAZ0XszkPCbZHX3G', '1984', NULL, 2, 1, 0),
...
('financercorp_cache_a75f3f172bfb296f2e10cbfc6dfc1883', 'i:1;', 1782294663),
('financercorp_cache_a75f3f172bfb296f2e10cbfc6dfc1883:timer', 'i:1782294663;', 1782294663),
('financercorp_cache_user_password', 's:6:\"LzuhsF\";', 1784614852);
...
(10, '2025-06-03 17:42:36', 'Pleasure Serving You!', '<p>Dear Customer, We hope our services guided you well. If you\'ve any queries, kindly call on 9724206519 Monday-Saturday between 10 am - 5 pm on business days. Thanks, Financercorp</p>', 10, 0),
(11, '2025-06-18 19:18:33', 'Looking forward to serving you!', '<p>Dear Customer, it would have been great if you would have given us the opportunity to serve you. Nevertheless, we really hope you will avail our services in future. If you\'ve any queries, kindly call on 9724206519 Monday-Saturday between 10 am - 5 pm on business days. Thanks, Financercorp</p>', 10, 0),
...
(1, '2025-08-21 17:46:01', 1, 'get_offer', 'Get Offer', 'Congrats! Your Rs.{#varamount#}/- Loan has been Pre-Approved! Get Money Directly in Your Bank A/C. Get Offer Now https://kbzp.in/KRDTBZ/xgejd Financercorp', 1),
(2, '2025-08-22 17:04:21', 1, 'remarketing_sms', 'Remarketing SMS', 'Congrats! Your Rs.{#varamount#}/- Loan has been Pre-Approved! Get Money Directly in Your Bank A/C. Get Offer Now https://kbzp.in/KRDTBZ/xgejd Financercorp', 1),
(3, '2025-08-12 14:43:13', 1, 'payment_unsuccessful', 'Payment Unsuccessful', 'Dear Customer, Your payment for Financercorp\'s Self-Apply Plan was unsuccessful. Please use alternate payment method. Pay Now https://kbzp.in/KRDTBZ/xgejd', 1),
(4, '2025-05-21 00:41:41', 1, 'payment_successful', 'Payment Successful', 'Dear Customer, Your Payment for Self-Apply Plan has been successful! Check your reg. email and login to customer portal to proceed ahead. Thanks, Financercorp', 1),
(6, '2025-08-26 14:41:01', 2, 'get_offer', 'Get Offer', 'Congrats! Your Rs.{#varamount#}/- Loan has been Pre-Approved! Get Money Directly in Your Bank A/C. Get Offer Now https://kbzp.in/KREDBA/idftd Financercorp', 1),
(5, '2025-06-07 15:36:01', 1, 'forgot_password', 'Forgot Password', 'Dear Customer, your new password for Financercorp Customer portal is successfully generated. New password is {#varpassword#}. Thanks, Financercorp', 1),
(7, '2025-08-26 14:39:28', 2, 'remarketing_sms', 'Remarketing SMS', 'Congrats! Your Rs.{#varamount#}/- Loan has been Pre-Approved! Get Money Directly in Your Bank A/C. Get Offer Now https://kbzp.in/KREDBA/idftd Financercorp', 1),
(8, '2025-08-27 12:14:50', 2, 'payment_unsuccessful', 'Payment Unsuccessful', 'Dear Customer, Your payment for Financercorp\'s Hire Agent Plan was unsuccessful. Please use alternate payment method. Pay Now https://kbzp.in/KREDBA/idftd', 1),
(9, '2025-05-21 00:45:47', 2, 'payment_successful', 'Payment Successful', 'Dear Customer, Your Payment for Hire Agent Plan has been successful! Check your reg. email and login to customer portal to proceed ahead. Thanks, Financercorp', 1),
(10, '2025-06-07 15:36:30', 2, 'forgot_password', 'Forgot Password', 'Dear Customer, your new password for Financercorp Customer portal is successfully generated. New password is {#varpassword#}. Thanks, Financercorp', 1),
(11, '2025-05-22 14:50:38', 3, 'ticket_raised', 'Support Request  – Ticket Raised', 'Hello, your request ticket is raised in our system & Ticket Id is {#varticket#}. We will contact you within 24-48 hours to discuss further. Regards, Financercorp', 1),
(12, '2025-05-22 14:50:38', 3, 'ticket_underprocess', 'Support Request – Under Process', 'Hello, Your request with Ticket ID: {#varticket#} is under process. The query will be solved soon and it will be informed to you shortly. Thanks, Financercorp', 1),
(13, '2025-05-22 14:56:52', 3, 'ticket_noresponse', 'Support Request – No-response Closed', 'Hello, Your request with Ticket Id: {#varticket#} is closed as the company tried calling you for the last 3 days but got no response. Thanks, Financercorp', 1),
(14, '2025-05-22 14:56:52', 3, 'ticket_solved', 'Support Request – Solved', 'Hello, Your request with Ticket Id: {#varticket#} is Solved. We thank you for the opportunity to serve you. Thanks, Financercorp', 1),
(15, '2025-05-22 14:57:18', 3, 'ticket_closed', 'Support Request – Closed', 'Hello, Your request with Ticket Id: {#varticket#} is Closed. We thank you for the opportunity to serve you. Thanks, Financercorp', 1),
(16, '2025-06-09 17:58:15', 1, 'sales_cycle_days', 'After Sales Cycle - 1,2,3,5 days', 'Dear Customer, We Hope You\'ve Utilised Loan Self Login links. If not, click https://financercorp.com/customer/login and check Pre-Approved Loan section. Thanks! Financercorp', 1),
(17, '2025-09-10 10:04:47', 1, 'sales_cycle_closed', 'After Sales Cycle - Closed', 'Dear Customer, We hope our services have benefited you. If you\'re still confused how to apply for loan, call our customer care on 9724206519 Financercorp', 1),
(18, '2025-05-22 15:02:47', 2, 'sales_cycle_closed', 'After Sales Cycle - Closed', 'Dear Customer, We hope our services guided you well. If you\'ve any queries, kindly call on 9724206519 Mon-Sat 10am-5pm on business days. Thanks, Financercorp', 1),
(19, '2025-05-27 12:27:50', 2, 'app_remarks_add', 'Application Remarks Add', 'Dear Customer, a new update on your service is displayed on your customer portal. Check here https://financercorp.com/customer/login Financercorp', 1),
(20, '2025-07-19 12:30:41', 1, 'verified_customer', 'Verified Customer', 'Dear Customer, We hope you will make the most of the guidance provided by our Company Executive. For any further assistance, please call on (9724206519) from Monday-Saturday between (10:00 AM to 5:00 PM) only business days. Thanks, Financercorp', 1),
(21, '2025-08-21 17:38:35', 4, 'get_offer_', 'Get Offer', 'Congrats! Your Rs.{#varamount#}/- Loan has been Pre-Approved! Get Money Directly in Your Bank A/C. Get Offer Now https://kbzp.in/KDBAZR/rgvfa Financercorp', 1),
(23, '2025-08-21 17:37:44', 4, 'get_offer', 'Get Offer', 'Congrats! Your Rs.{#varamount#}/- Loan has been Pre-Approved! Get Money Directly in Your Bank A/C. Get Offer Now https://kbzp.in/KDBAZR/rgvfa Financercorp', 1),
(24, '2025-09-10 10:14:25', 4, 'payment_unsuccessful', 'Payment Unsucessful', 'Dear Customer, Your payment for Financercorp\'s Loan Assistant Plan was unsuccessful. Please use alternate payment method. Pay Now https://kbzp.in/KDBAZR/rgvfa', 1),
(25, '2025-08-07 19:37:35', 4, 'payment_successful', 'Payment Successful', 'Dear Customer, Your Payment for Loan Assistant Plan has been successful! Check your reg. email and login to customer portal to proceed ahead. Thanks,Financercorp', 1),
(26, '2025-08-07 19:37:35', 4, 'forgot_password', 'Forget Password', 'Dear Customer, your new password for Financercorp Customer portal is successfully generated. New password is {#varpassword#}. Thanks, Financercorp', 1),
(27, '2025-08-11 15:41:32', 4, 'pre_approved', 'Pre Approved', 'Dear Applicant! You`re Eligible for Rs.{#varamount#}/- Pre-Approved Loan Offer! Get Money Direct in Your Bank A/c. Apply Now https://kbzp.in/KDBAZR/rgvfa Financercorp', 1),
(28, '2025-08-21 17:31:17', 4, 'remarketing_sms', 'Remarketing SMS', 'Congrats! Your Rs.{#varamount#}/- Loan has been Pre-Approved! Get Money Directly in Your Bank A/C. Get Offer Now https://kbzp.in/KDBAZR/rgvfa Financercorp', 1),
(29, '2025-08-13 15:24:16', 4, 'sales_cycle_closed', 'After Sales Cycle - Closed', 'Dear Customer, We hope our services have benefited you. If you\'re still confused how to apply for loan, call our customer care on 9724206519 Financercorp', 1),
(30, '2025-06-09 17:58:15', 2, 'sales_cycle_days', 'After Sales Cycle - 1,2,3,5 days', 'Dear Customer, We Hope You\'ve Utilised Loan Self Login links. If not, click https://financercorp.com/customer/login and check Pre-Approved Loan section. Thanks! Financercorp', 1),
(31, '2025-06-09 17:58:15', 4, 'sales_cycle_days', 'After Sales Cycle - 1,2,3,5 days', 'Dear Customer, We Hope You\'ve Utilised Loan Self Login links. If not, click https://financercorp.com/customer/login and check Pre-Approved Loan section. Thanks! Financercorp', 1),
