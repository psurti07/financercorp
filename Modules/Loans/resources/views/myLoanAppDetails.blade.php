                    ...
                    <div class="card-body">
                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-senter">
                                    <span class="text-gray-900 fw-bolder fs-6">{{ $agentDetails->fullname ?? 'Financercorp Support' }}</span>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-3"></div>
                            <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex flex-stack">
                                ...
                                <div class="d-flex align-items-senter">
                                    <span class="text-gray-900 fw-bolder fs-6">{{ $agentDetails->emailid ?? 'support@financercorp.com' }}</span>
                                </div>
                            </div>
                            <div class="separator separator-dashed my-3"></div>
                            <div class="d-flex flex-stack">
