...
@section('title','Welcome to Financercorp! ')
@push('style-css')
@endpush
...
@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div class="container-xxl " id="kt_content_container">
                                                        ...
                                                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                                                    <div class="d-flex flex-column">
                                                                        <div class="d-flex align-items-center mb-2">
                                                                            <a href="javascript:;" class="text-gray-900 text-hover-success fs-2 fw-bold me-1">{{ isset($agent->fullname) ? $agent->fullname : 'Financercorp Support' }}</a>
                                                                        ...
                                                                        <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                                                            ...
                                                                            <a href="javascript:;" class="d-flex align-items-center text-gray-700 text-hover-success mb-2">
                                                                                <i class="ki-duotone ki-sms fs-4 me-1"><span class="path1"></span><span class="path2"></span></i>
                                                                                {{ $agent->emailid ?? 'support@Financercorp.com' }}
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="card border mt-10" data-bs-theme="light">
                                <div class="card-body">
                                    <div class="align-items-center">
                                        <div class="pt-4" style="color:#48a111 !important">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                    <h6 class="text-danger"><marquee scrollamount="8" behavior="scroll">BE AWARE! We ask our customers to make payments ONLY on our website https://financercorp.com and NOT through any other source, directly or indirectly. Thanks!</marquee></h6>
                </div>
            </div>
        </div>
    </div>
