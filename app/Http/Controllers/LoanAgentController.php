        ...
        try {
            ...
            if ($responseCode == 100) {
                ...
                if (!$existingInvoice) {
                    ...
                    /* send email in brevo */
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Payment for Financercorp’s Hire Agent plan has been successful.', $sendGreetings, 3, $attachments);
        ...
        try {
            ...
            $request = array(
                ...
                "parameter" => [
                    ...
                    'receiver_vpa' => "cpy.financercorp@finobank",
