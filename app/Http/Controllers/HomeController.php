...
class HomeController extends Controller
{
    ...
    public function storeCareer(Request $request){
        ...
        if($result){
           try {
                $maildata = array(
                    'fullname' => "Financercorp HR",
                    'email' => "hr@financercorp.com"
                );
                $maildata2 = array(
                ...
                $subject2 = 'Welcome to Financercorp';
    ...
    public function testdata(){
       $mailData = array(
        ...
        /* send email in brevo */
        $res = sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for Financercorp’s Self-Apply Plan.', $sendGreetings, 3, $attachments);
