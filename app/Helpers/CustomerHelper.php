		...
		function convertIntoCustomer($cardno, $userData, $cardData, $orderAmount, $txnId, $accType, $slug, $prefix, $offerpage) {
		    try {
                ...
                try
                {
                    ...
                    $subject = (($accType == 2)
                        ? 'Congratulations! Payment for Financercorp’s Hire Agent plan has been successful.'
                        : (($accType == 3) 
                        ? 'Congratulations! Payment for Financercorp’s Self-Apply plan has been successful.'
                        : 'Congratulations! Payment Successful for Financercorp’s Self-Apply Plan.'));
