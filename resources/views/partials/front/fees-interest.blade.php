        ...
        <div class="row justify-content-center">
            <div class="col-md-12 col-lg-12">
                <div class="section-title mb-40">
                    ...
                    <p class="s-16">Financercorp provides access to personal loans with <strong>competitive interest rates</strong> and <strong>transparent fees</strong>. Since we partner with multiple NBFCs, you can choose from a variety of loan offers that suit your financial requirements.</p>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
