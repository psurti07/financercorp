                ...
                <div class="col-md-10 col-lg-10 col-sm-12 form-details-section">
                    <div class="col-md-12 py-20">
                        <div class="txt-block text-center">
                            ...
                            <a href="{{ route('workshop.step1') }}" class="btn r-04 btn--theme hover--tra-white last-link">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row align-items-center mt-30">
            <div class="col-lg-7 col-md-7 col-12">
                <div class="step-info pe-lg-5">
                    ...
                    <div class="step-card p-3 mb-3 border border-radius-10 border-grey-1 ">
                        <h5 class="mb-2">2. Enrol in Programs & Workshops</h5>
                ...
                <div class="owl-carousel owl-theme testimonials-carousel">
                    ...
                    <div class="review-1 bg--white-100 block-shadow r-08">
                        <div class="review-txt pt-30">
                            ...
                            <p class="p-sm"><i>"Well done Financercorp team, your guidance really makes a big difference. Also services are superb"</i></p>
                        </div>
                    </div>
                    <div class="review-1 bg--white-100 block-shadow r-08">
                        <div class="review-txt pt-30">
                    ...
                    <div class="review-1 bg--white-100 block-shadow r-08">
                        <div class="review-txt pt-30">
                            ...
                            <p class="p-sm"><i>“It just went beyond my expectations. It’s so easy to get effective loan consultation with Financercorp”</i></p>
                        </div>
                    </div>
                </div>
            </div>
