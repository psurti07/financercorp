...
@section('content')
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6 col-lg-6 col-12">
                        <div class="hero-7-img home-img d-flex justify-content-center align-items-start">
                            <img src="{{ asset('front/images/hero-1-img.png') }}" alt="financercorp" width="auto" height="auto">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-40">
                        <h2 class="s-28">About <span class="color--green-500">Financer Corp</span></h2>
                        <p class="s-16 color--grey">Converting Financial Difficulties Into Dream Fulfillment</p>
                    </div>
                </div>

                <div class=" col-12">
                    <div class="txt-block text-center">
                        <p class="">At Financer Corp, we are committed to making financial solutions more accessible, reliable, and convenient for individuals across India. Backed by enriching partnerships with multiple industry-leading NBFCs, we offer premier financial consultation and services designed to match different financial needs.</p>
                        <p class="">Our focus is on understanding what works best for each individual and guiding them with personalized support at every step. With a team of seasoned experts and our streamlined digital portal, we help people make sound financial decisions and move forward with more confidence and clarity.</p>
                        <p class="">Customer satisfaction remains at the heart of everything we do. Through this customer-first approach, we ensure every individual receives the experience and services they look for while fulfilling their financial goals with ease. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- why Financercorp section starts -->
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-50">
                        ...
                        <p class="s-16 color--grey">Because Your Dreams Deserve Smart Support</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col">
                        <div class="fbox-8 fbox--hover fb-1 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>Gain access to several industry-leading NBFCs, all from the comfort of your home.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="fbox-8 fbox--hover fb-2 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>Relax and enjoy premier financial services in a very simple and convenient way.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="fbox-8 fbox--hover fb-2 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>Make your financial journey easier with the help of our experienced professionals.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="fbox-8 fbox--hover fb-3 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>Apply yourself or hire a loan agent – Proceed in a way that is most convenient for you.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="statistic-block">
                                <div class="statistic-digit">
                                    <h2 class="s-30 w-700 mb-10">
                                        <span class="count-element">4500</span>+
                                    </h2>
                                </div>
                    ...
                    <div class="col sec-2">
                        <div id="sb-5-3" class="text-center">
                            <div class="statistic-block">
                                <div class="statistic-digit">
                                    <h2 class="s-30 w-700 mb-10">
                                        <span class="count-element">4</span>.<span class="count-element">5</span>Cr+
                                    </h2>
                                </div>
                                <div class="statistic-txt">
                                    <h5 class="s-16 w-500">Successful Disbursals</h5>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-40">
                        ...
                        <p class="s-16 color--grey">6 Easy Steps To Get Started</p>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4 row-cols-1 row-cols-md-3 row-cols-lg-3">
                    <div class="col">
                        <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                <p>Begin the process by entering your full name, registered number, email address, and other required information.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                <p>Our system will determine your eligibility based on the information you provided. Please note that this is not a final offer.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                <p>Gain access to the displayed offer by purchasing the plan that best meets your needs and preferences.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                <p>Our team will contact you within 24-48 hours for verification and guide you through the next steps to ensure a smooth process. </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                <p>The NBFC will review your profile and documents in accordance with their policies and procedures.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="fbox-7 fbox--hover bg--white-100 fb-1 r-12 h-100">
                            ...
                            <div class="fbox-txt">
                                <p>The NBFC will make the final decision on loan approval, sanction, and disbursement based on their terms.</p>
                            </div>
                        </div>
                    </div>
    ...
    <section id="features-21" class="py-80 features-section division">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-10">
                    <div class="section-title mb-40">
                        <h2 class="s-28">Calculate <span class="color--green-500">Your EMI Instantly</span></h2>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-lg-10">
                        <div class="section-title mb-50">
                            ...
                            <p class="s-16 color--grey">Collaborating With The Finest In The Industry</p>
                        </div>
                    </div>
                </div>
                @php
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title mb-40">
                        <h2 class="s-28">Words That Keeps Us <span class="color--green-500">Going</span></h2>
                        <p class="s-16 color--grey">Hear It Directly From Our Customers</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 md-mb-50">
                    <div class="sec-title2 mb-40">
                        <h2 class="s-28">Connect With <span class="color--green-500">Our Experts</span></h2>
                        <p class="description">Send Us A Message, & We Will Get Back To You Shortly</p>
                    </div>
