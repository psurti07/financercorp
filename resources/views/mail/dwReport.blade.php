                                                    ...
                                                    <tr>
                                                        <td align="left"
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                align="left"
                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #f2fff2;border: 1px solid #48a111;  border-radius: 12px; display: block;">
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            style="padding: 0; margin: 0; width: 600px;">
                                                                            <h3 style="text-align:center; color: #48a111;font-family: Poppins, sans-serif;">
                                                                                Personal Details / Subscription Details
                                                                            </h3>
                                                                            <hr>
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                width="100%" bgcolor="#ffffff"
                                                                                style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px;/* border: 1px solid #48a111; */ background-color: transparent;"
                                                                                role="presentation">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #f2fff2; color:#000;font-size:16px; border-radius: 12px;font-family: Poppins, sans-serif;">
                                                                    ...
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table width="100%" bgcolor="#ffffff" style="border-radius: 15px; background-color: transparent;margin-bottom:15px;">
                                                                                <tr>
                                                                                    <td style="padding: 0 20px; background-color: #f2fff2; color: #000; font-size: 16px; border-radius: 12px;font-family: Poppins, sans-serif;">
                                                                                        <table width="100%" style="width: 100%;">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><h5 style="margin:0">{{ $agent->fullname ?? 'financercorp Support' }}</h5></td>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                ...
                                                                <tbody>
                                                                        ...
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <span style="display:flex; justify-content:center; color: #48a111;font-family: Poppins, sans-serif;">Loan Amount - ₹&nbsp;<strong>{{ formatePriceIndia($offers[0]->loanAmount) }}</strong></span>
                                                                            <hr>
                                                                            <table class="offers-table">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr style="font-family: Poppins, sans-serif;">
                                                                                        ...
                                                                                        <td><img src="https://manage.financercorp.com/public/upload/banks/{{ $offer->bank_image }}" alt="{{ $offer->bank_name }}" class="bank-logo"></td>
