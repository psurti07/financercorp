                                                                                                                                            ...
                                                                                                                                            <tbody>
                                                                                                                                                ...
                                                                                                                                                <tr>
                                                                                                                                                    <td align="left"
                                                                                                                                                        ...
                                                                                                                                                        <p> Congratulations {{ $userData->firstname }} {{ $userData->lastname }},</p>
                                                                                                                                                        <p>
                                                                                                                                                            You have successfully registered for our upcoming live webinar. 🎉
                                                                                                                                                        </p>
                                                                                                                                                        <p>
                                                                                                                                                            We’re excited to have you with us. To receive all updates and important information about the webinar, please join our community using the link below:  
                                                                                                                                                        </p>
                                                                                                                                                        <p><a href="{{ $webinar->community_link ?? '' }}"> {{ $webinar->community_link ?? '' }} </a></p>
                                                                                                                                                        <p>
