                                                                    ...
                                                                    <td class="es-m-p20b" align="left"
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        style="padding: 20px; margin: 0; line-height: 2rem;    background-color: #f2fff2;border-top-right-radius:12px;border-top-left-radius:12px;">
                                                                                        <p
                                                                                            style="font-size:2.2rem;color:#48a111;font-weight:600">
                                                                                            Congratulations!
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <p>Hi {{ $fullname }}</p>
                                                                                        <p>Congratulations on taking the
                                                                                            first step toward accessing
                                                                                            your personalised
                                                                                            pre-approved loan offers and
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p20b" align="left"
                                                                        style="padding: 0; margin: 0; width: 600px;">
                                                                        <h3 style="text-align:center; color: #48a111;">
                                                                            Order Details
                                                                        </h3>
                                                                        <hr>
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td
                                                                                        style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #f2fff2; color:#000;font-size:16px; border-radius: 12px;">
                                                                    ...
                                                                    <td class="es-m-p20b" align="left"
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        style="padding: 20px; margin: 0; line-height: 1.5rem;background-color: #f2fff2; border-radius:12px;color:#000;font-size:16px">
                                                                                        <p>
                                                                                        ...
                                                                                        <p>Our Loan Consultant will
                                                                                            reach out to you within 24
                                                                                            to 48 hours.</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
