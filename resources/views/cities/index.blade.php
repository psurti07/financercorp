            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title mb-40">
                        <h2 class="s-34 w-700">Why Choose Financercorp for a Personal Loan in {{ ucwords($city) }}?</h2>
                    ...
                    <div class="col">
                        <div class="fbox-11 fb-1 mb-20 height14">
                            ...
                            <div class="fbox-txt">
                                ...
                                <p>Whether you're a private employee, government worker, or running your own business – you can easily get a personal loan in {{ ucwords($city) }} through Financercorp.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="accordion">
                                ...
                                <li class="accordion-item mb-10">
                                    ...
                                    <div class="accordion-panel">
                                        <div class="accordion-panel-item">
                                            <div class="faqs-2-answer">
                                                <p>No. You can apply for a personal loan completely online through Financercorp. No office visit required.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
