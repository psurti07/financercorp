...
@push('css')
    ...
    <style>
        ...
        .radio:checked{ background: #48a111; border-color: #48a111; }
                ...
                <div class="col-md-6 col-lg-6 self-apply-form">
                    <div id="hero-8-form" class="border border-primary r-06">
                        ...
                        <form method="post" action="{{ route('loan.agent.send.otp') }}" class="request-form save-form-1 needs-validation" novalidate>
                            ...
                            <p class="mb-0 s-14 text-start text-dark">By submitting, you agree to Financercorp's <a href="{{ route('front.terms.conditions') }}"  target="_blank"class="text-dark text-decoration-none">Terms of Use</a> and <a href="{{ route('front.privacy.policy') }}" class="text-dark text-decoration-none" target="_blank">Privacy Policy</a>, and consent to receive promotional and informational messages via email, call, or SMS.</p>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10 col-lg-9">
                    <div class="section-title mb-50">
                        <h2 class="s-28">Why <span class="color--green-500">Financercorp</span></h2>
