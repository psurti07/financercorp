                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-12">
                                                        ...
                                                        <div id="fb-12-3" class="fbox-12 bg--white-100 block-shadow r-12 mb-20">
                                                            ...
                                                            <div class="fbox-ico">
                                                                <div class="shape-ico">
                                                                    <img class="p-0" src="https://manage.financercorp.com/public/upload/banks/{{ $offersData[0]['bank_image'] }}" alt="bank" width="160">
                                                                </div>
                                                            </div>	<!-- End Icon -->
                                                    ...
                                                    @foreach($offersData as $index => $item)
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-12">
                                                            ...
                                                            <div id="fb-12-3" class="fbox-12 bg--white-100 block-shadow r-12 mb-20 lockoffers">
                                                                ...
                                                                <div class="fbox-ico">
                                                                    <div class="shape-ico">
                                                                        <img class="p-0" src="https://manage.financercorp.com/public/upload/banks/{{ $item['bank_image'] }}" alt="bank" width="160">
                                                                    </div>
                                                                </div>	<!-- End Icon -->
